...
/*
    Generates a URL for users to be redirected when initiating 3-legged authenticaton
*/
...
/*
    an Express.js middleware for handling callback from login auth to our app 
*/
...
/*
    // an Express.js middleware for all the requests that will need to make use of the APS access tokens
*/
...
/*
    // returns additional details about the authenticated user based on an existing access token
*/
